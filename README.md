...
- _Orchestration_ - **Airflow**
- _Data Storage_ - **Postgres**
- _Languages_ - **Python, SQL**
- _Testing_ - **SODA**, **pytest**
...
- _produce_json_ - DAG to produce JSON file with raw data
- _update_db_ - DAG to process JSON file and insert data into booth staging and core schemas
- _data_quality_ - DAG to check the data quality on both layers in the database
